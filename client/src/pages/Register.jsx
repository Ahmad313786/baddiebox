...
const Register = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    setError("");
    try {
      const res = await axios.post(`${backendUrl}/api/otp/sendotp`, { email: form.email });
      if (res.data.success) {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setError("");
    try {
      const res = await axios.post(`${backendUrl}/api/otp/verifyotp`, { email: form.email, otp: form.otp });
      if (res.data.success) {
